...
export default function EditPartnerPage() {
  ...
  const partnerRef = useMemoFirebase(() => partnerId ? doc(firestore, "partners", partnerId) : null, [firestore, partnerId]);
  ...
  async function onSubmit(data: PartnerFormValues) {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "There was a problem updating the partner's details.",
        variant: "destructive",
      });
    }
  }
  ...
  return (
    <div className="space-y-6">
       <div className="flex items-center gap-4">
            ...
            <div>
                <h1 className="text-3xl font-headline">Edit Partner: {partner.name}</h1>
      ...
      <Card className="shadow-lg max-w-4xl mx-auto">
        <CardHeader>
            ...
            <CardDescription>Update the partner's information.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
