...
export default function NewOperatorPage() {
  ...
  async function onSubmit(data: OperatorFormValues) {
    try {
        await addDoc(collection(firestore, "operators"), {
            ...data,
        ...
        toast({
            title: "Error",
            description: "There was a problem creating the operator.",
            variant: "destructive"
        })
    }
  }
  ...
  return (
    <div className="space-y-6">
       <div>
            <h1 className="text-3xl font-headline">Add New Operator</h1>
            <p className="text-muted-foreground">
                Fill out the form below to add a new operator to the system.
            </p>
        </div>
